						...
						{{--@foreach($entities as $entity)--}}
							{{--<li class="treeview">--}}
								{{--<a href="#">--}}
									...
									{{--<span>{{ucfirst($entity->tablename)}}</span>--}}
									{{--<i class="fa pull-right fa-angle-left"></i>--}}
								{{--</a>--}}
								{{--<ul class="treeview-menu" style="display: none;">--}}
									{{--<li><a href="{{url('/')}}/{{lcfirst(str_singular($entity->tablename))}}" style="margin-left: 10px;"><i class="fa fa-angle-double-right"></i> Consultar</a></li>--}}
									{{--<li><a href="{{url('/')}}/{{lcfirst(str_singular($entity->tablename))}}/create" style="margin-left: 10px;"><i class="fa fa-angle-double-right"></i> Cadastrar</a></li>--}}
								{{--</ul>--}}
							{{--</li>--}}
						{{--@endforeach--}}
					</ul>
